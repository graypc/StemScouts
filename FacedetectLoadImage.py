...
def main():
    # Set up argument parser to get an image name from command line args.
    parser = argparse.ArgumentParser(description="Display images and detect faces.")
    parser.add_argument("--filename", required=True, help = "JPG file to display.")

    args = parser.parse_args()
    filename = args.filename

    # Have opencv read the image from the filename.
